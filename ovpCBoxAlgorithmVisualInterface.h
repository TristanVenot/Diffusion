...
namespace OpenViBEPlugins
{
	namespace SignalProcessing
	{
		...
		*/
		...
		enum EVisualInterfaceState
		{
			EVisualInterfaceState_Idle,
			EVisualInterfaceState_Reference,
			EVisualInterfaceState_Cue,
			EVisualInterfaceState_ContinousFeedback
		};
		...
		public:
			...
			EVisualInterfaceState m_eCurrentState;
			EArrowDirection m_eCurrentDirection;

			GdkPixbuf *m_pLeftHand;
			GdkPixbuf *m_pLeftHandmodified;
			...
			int m_i64PredictionsToIntegrate;
